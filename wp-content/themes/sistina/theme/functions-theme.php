...
if ( is_admin() && false === get_transient( 'yit_removeYIWLink' ) && version_compare( wp_get_theme()->get( 'Version' ), '1.8.4', '<=')  ) {
    ...
    function convert_yit_url( &$item, $key, $type ) {
        ...
        switch ( $type ) {
            ...
            case 'in_export' :
                ...
                yit_update_db_value('http://yourinspirationtheme.com/demo/','sistina',$item,$item_type,$type);
                yit_update_db_value('http://www.yourinspirationweb.com/demo/','sistina',$item,$item_type,$type);
                yit_update_db_value('http://yourinspirationtheme.com/tf/','sistina',$item,$item_type,$type);
